...
/**
 * imagerelationship FieldType Constructor
 * @extends Field
 * @api public
 */
function imagerelationship(list, path, options) {
  ...
  imagerelationship.super_.call(this, list, path, options);
}
util.inherits(imagerelationship, FieldType);

/**
 * Get client-side properties to pass to react field.
 */
imagerelationship.prototype.getProperties = function() {
...
imagerelationship.prototype.getExpandedData = function(item) {
 ...
 */
imagerelationship.prototype.addToSchema = function() {
  var field = this;
 ...
 */
imagerelationship.prototype.addFilterToQuery = function(filter, query) {
  query = query || {};
 ...
 */
imagerelationship.prototype.format = function(item) {
  var value = item.get(this.path);
 ...
 */
imagerelationship.prototype.inputIsValid = function(data, required, item) {
...
imagerelationship.prototype.updateItem = function(item, data, callback) {
  ...
  if (item.populated(this.path)) {
    throw new Error('fieldTypes.imagerelationship.updateItem() Error - You cannot update populated imagerelationships.');
  }
  if (this.many) {
...
/**
 * Returns true if the imagerelationship configuration is valid
 */
Object.defineProperty(imagerelationship.prototype, 'isValid', {
  get: function() {
 ...
 */
Object.defineProperty(imagerelationship.prototype, 'refList', {
  get: function() {
 ...
 */
Object.defineProperty(imagerelationship.prototype, 'hasFilters', {
  get: function() {
...
/**
 * Adds imagerelationship filters to a query
 */
// TODO: Deprecate this? Not sure it's used anywhere - JW
imagerelationship.prototype.addFilters = function(query, item) {
...
/* Export Field Type */
module.exports = imagerelationship;
