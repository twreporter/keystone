// NOTE:
// After the infomation architecture migration is done, this file can be deleted.
// https://twreporter-org.atlassian.net/browse/TWREPORTER-329
...
import { NEW_SUBCATEGORY_IDS } from '../CategoryConstants';
...
module.exports = Field.create({
  ...
  cacheItem(item) {
    // Filter out new version tags for old/new compatible
    if (item && NEW_SUBCATEGORY_IDS.includes(item.id)) {
      return;
    }
