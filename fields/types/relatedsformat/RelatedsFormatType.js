...
/**
 * relatedsformat FieldType Constructor
 * @extends Field
 * @api public
 */
function relatedsformat (list, path, options) {
	this.ui = options.ui || 'relatedsformat';
	...
	if (!Array.isArray(options.options)) {
		throw new Error('relatedsformat fields require an options array.');
	}
	...
	relatedsformat.super_.call(this, list, path, options);
}
util.inherits(relatedsformat, FieldType);

/**
 * Registers the field on the List's Mongoose Schema.
 *
 * Adds a virtual for accessing the label of the relatedsformated value,
 * and statics to the Schema for converting a value to a label,
 * and retrieving all of the defined options.
 */
relatedsformat.prototype.addToSchema = function () {
	var field = this;
 ...
 */
relatedsformat.prototype.cloneOps = function () {
 ...
 */
relatedsformat.prototype.cloneMap = function () {
 ...
 */
relatedsformat.prototype.addFilterToQuery = function (filter, query) {
	query = query || {};
 ...
 */
relatedsformat.prototype.inputIsValid = function (data, required, item) {
	if (data[this.path]) {
 ...
 */
relatedsformat.prototype.format = function (item) {
	return this.labels[item.get(this.path)] || '';
};

/* Export Field Type */
module.exports = relatedsformat;
