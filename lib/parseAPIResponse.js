...
function composeImageSet(imageObj = {}) {
  ...
  return _.merge(image, resizedTargets, {
    ...
    id: imageObj.id,
    is_sensitive: imageObj.is_sensitive || false,
  });
}
...
module.exports.parseImageAPIResponse = function(apiResponse) {
  ...
  let is_sensitive = _.get(apiResponse, ['fields', 'is_sensitive'], false);
  let image = _.merge({}, imageObj, { id, description, keywords, is_sensitive });
