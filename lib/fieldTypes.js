var fields = {
  ...
  get GcsFile() { return require('../fields/types/gcsfile/GcsFileType'); },
  get GcsImage() { return require('../fields/types/gcsimage/GcsImageType'); },
  get GcsAvatar() { return require('../fields/types/gcsavatar/GcsAvatarType'); },
  ...
  get Preview() { return require('../fields/types/preview/PreviewType'); },
  get RelatedsFormat() { return require('../fields/types/relatedsformat/RelatedsFormatType'); },
  get Relationship() { return require('../fields/types/relationship/RelationshipType'); },
  get ImageRelationship() { return require('../fields/types/imagerelationship/ImageRelationshipType'); },
  get S3File() { return require('../fields/types/s3file/S3FileType'); },
  get Select() { return require('../fields/types/select/SelectType'); },
  get TitlePosition() { return require('../fields/types/titleposition/TitlePositionType'); },
  ...
  get CategorySet() { return require('../fields/types/categorySet/CategorySetType'); },
  get Tag() { return require('../fields/types/tag/TagType'); },
};
